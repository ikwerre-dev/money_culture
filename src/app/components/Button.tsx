...
export default function Button({ variant, children, onClick, className = '' }: ButtonProps) {
    ...
    const variants = {
        ...
        gradient: "border-2 order-gradient-to-r bg-gradient-to-r from-[#094E8D] to-[#5DBA51] text-white hover:opacity-90 flex justify-center flex-row text-center items-center gap-2"
    };
